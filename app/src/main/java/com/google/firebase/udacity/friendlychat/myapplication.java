...
String h;int uo;boolean yw=true;
...
String p,q,r;
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {MainActivity.act=0;
        super.onCreate(savedInstanceState);
p=SecondActivity.x;q=SecondActivity.y;r=SecondActivity.z;
...
s=getSharedPreferences("user",0);
       ...
       c=findViewById(R.id.edoptionb);
        ...
        f.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {String hp="";
                String o=a.getText().toString();hp=hp+o;hp=hp+"/";
                g.setText(o);
                o=b.getText().toString();hp=hp+o;hp=hp+"/";
                tvoption1.setText(o);
                o=c.getText().toString();hp=hp+o;hp=hp+"/";
                tvoption2.setText(o);
                o=d.getText().toString();hp=hp+o;hp=hp+"/";
                tvoption3.setText(o);
                o=e.getText().toString();hp=hp+o;
                tvoption4.setText(o);
                count1=count2=count3=count4=0;
                calculatePercentage();
                lo.setVisibility(View.GONE);formatter = new SimpleDateFormat("h:mm a");
                huo=formatter.format(new Date());
                FriendlyMessage ok=new FriendlyMessage(hp,"rohith",null,huo);
                oMessagesDatabaseReference.push().setValue(ok); SharedPreferences.Editor esy = s.edit();
                esy.remove("user");
                esy.apply();
                esy.putInt("user", 0);
                esy.apply();uo=s.getInt("user", 0);
            }
        });
...
//Toast.makeText(MainActivity.this,"Hello",Toast.LENGTH_SHORT).show();
        quraey.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                }String ga="";String u="";long y = 0,w = 0;
                for(int i=0;i<lo.length();i++){u="";u=u+lo.charAt(i);
                    if(!u.equals("/")){ga=ga+lo.charAt(i);}
                    else{y=i;break;}

                }s1=ga;g.setText(ga);String g="";u="";
                for(int i=(int) y+1;i<lo.length();i++){u="";u=u+lo.charAt(i);
                    if(!u.equals("/")){g=g+lo.charAt(i);}
                    else{y=i;break;}
                ...
                tvoption4.setText(g);count1=count2=count3=count4=0;
                calculatePercentage(); SharedPreferences.Editor esy = s.edit();
                esy.remove("user");
                esy.apply();
                esy.putInt("user", 0);
                esy.apply();uo=s.getInt("user", 0);yw=true;
            }
...
tvoption4.setText(s5);
        lo=findViewById(R.id.dhon);lo.setVisibility(View.GONE);
...
uo=s.getInt("user", 0);
     ...
     tvoption1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uo==1){
                    Toast.makeText(myapplication.this,"You have already submitted your response",Toast.LENGTH_SHORT).show();yw=false;calculatePercentage();return;}
                ...
                h=h+"o";
                h=h+count4;
                Log.d("TAGE",h);formatter = new SimpleDateFormat("h:mm a");
                huo=formatter.format(new Date());
                ...
                esy.apply();
                esy.putInt("user", 1);
                esy.apply();uo=s.getInt("user", 0);yw=false;
        ...
        tvoption2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uo==1){
                    Toast.makeText(myapplication.this,"You have already submitted your response",Toast.LENGTH_SHORT).show();calculatePercentage();yw=false;return;}
...
//Toast.makeText(MainActivity.this,"Hello",Toast.LENGTH_SHORT).show();
        qury.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
               String lo = "";
                ...
                String g="";String u="";long y = 0,w = 0;
                for(int i=0;i<lo.length();i++){u="";u=u+lo.charAt(i);
                    if(!u.equals("o")){g=g+lo.charAt(i);}
                    else{y=i;break;}

                }if(g.equals("")){return ;}count1=Integer.parseInt(g);g="";u="";
                for(int i=(int) y+1;i<lo.length();i++){u="";u=u+lo.charAt(i);
                    if(!u.equals("o")){g=g+lo.charAt(i);}
                    else{y=i;break;}
    ...
    private void calculatePercentage() {
       ...
       /* percent1 =roundDouble(percent1);
        ...
        String y;
        if(you==0.00){y="0.00%";}
else{ y= String.format("%.2f", percent1);y=y+"%";}
        tvpercent1.setText(y);
        seekBar1.setProgress((int) percent1);
        you= (int) Math.ceil(percent2);
        if(you==0.00){y="0.00%";}
        else{ y= String.format("%.2f", percent2);y=y+"%";}
        tvpercent2.setText(y);
        seekBar2.setProgress((int) percent2);
        you= (int) Math.ceil(percent3);
        if(you==0.00){y="0.00%";}
        else{ y= String.format("%.2f", percent3);y=y+"%";}

        tvpercent3.setText(y);
        seekBar3.setProgress((int) percent3);you= (int) Math.ceil(percent4);
        if(you==0.00){y="0.00%";}
        else{ y= String.format("%.2f", percent4);y=y+"%";}
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.ClearPoll:
                mUsernam=MainActivity.mUsername;

                if(mUsernam == null){mUsernam=QuizActivity.mUsername;
                if(mUsernam==null){return true;}
                }
                mUsernam.trim();
                Log.d("TAGE",mUsernam);
            ...
            case R.id.CreatePoll:
                mUsernam=MainActivity.mUsername;count1=count2=count3=count4=0;
                calculatePercentage();
                if(mUsernam == null){mUsernam=QuizActivity.mUsername;
                if(mUsernam==null){return true;}
            }
